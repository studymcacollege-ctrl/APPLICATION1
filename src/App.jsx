...
// ✅ PAGE IMPORTS - Sirf App.jsx mein
...
// ✅ Helper Component: Navigation based on viewMode
  ...
  if (viewMode === "user") {
    return (
      <>
        ...
        <Link to="/quiz" style={{...styles.navLink, ...isActive("/quiz")}}>🎯 Play Quiz</Link>
        <Link to="/scores" style={{...styles.navLink, ...isActive("/scores")}}>🏆 Leaderboard</Link>
...
function App() {
  ...
  const [viewMode, setViewMode] = useState(() => {
    return localStorage.getItem("quizAppViewMode") || "user";
  });

  // ✅ Save preference to localStorage
  useEffect(() => {
    localStorage.setItem("quizAppViewMode", viewMode);
  }, [viewMode]);
  ...
  const toggleView = () => {
    setViewMode(prev => {
      ...
      // Redirect to appropriate home page on toggle
      if (newMode === "user") {
      ...
      <div style={styles.appContainer}>
        ...
        <header style={styles.header}>
          <div style={styles.headerContent}>
            ...
            <h1 style={styles.logo}>
              {viewMode === "admin" ? "🛠️ Admin Panel" : "🎯 Quiz Master"}
            </h1>

            {/* ✅ Dynamic Navigation */}
            <nav style={styles.nav}>
              <AppNav viewMode={viewMode} />
            </nav>
        ...
        <main style={styles.main}>
          <Routes>
            ...
            {/* 🔐 ADMIN ROUTES - Always accessible (auth handled in page) */}
            <Route path="/admin" element={<AdminPanel />} />
            <Route path="/admin/quizzes" element={<AdminPanel />} />
...
const styles = {
  ...
  headerContent: {
    maxWidth: "1280px", margin: "0 auto", padding: "12px 20px",
  ...
  navLink: {
    color: "#1e40af", textDecoration: "none", padding: "8px 14px",
    borderRadius: "50px", fontSize: "0.9rem", fontWeight: "500",
    transition: "all 0.2s ease", background: "transparent", border: "2px solid transparent",
  },
  loginLink: {
    color: "#2563eb", textDecoration: "none", padding: "8px 14px",
    borderRadius: "50px", fontSize: "0.9rem", fontWeight: "500",
    border: "2px solid #2563eb", transition: "all 0.2s ease",
  },
  adminLink: {
    color: "#fff", textDecoration: "none", padding: "8px 14px",
    borderRadius: "50px", fontSize: "0.9rem", fontWeight: "500",
    background: "linear-gradient(135deg, #3b82f6, #60a5fa)",
    border: "2px solid #3b82f6", transition: "all 0.2s ease",
  },
  
  // ✅ Toggle Switch Styles
  toggleContainer: {
    display: "flex", alignItems: "center", gap: "8px",
    background: "#f1f5f9", padding: "6px 12px", borderRadius: "25px",
  ...
  slider: {
    ...
    backgroundColor: "#cbd5e1", transition: "0.3s", borderRadius: "24px",
  },
  main: {
    maxWidth: "1280px", margin: "0 auto", padding: "30px 20px",
    minHeight: "calc(100vh - 80px)", display: "flex", flexDirection: "column", alignItems: "center",
  },
  card: {
    width: "100%", maxWidth: "500px", background: "#ffffff", padding: "40px 30px",
    borderRadius: "20px", boxShadow: "0 8px 30px rgba(59, 130, 246, 0.12)",
    border: "1px solid rgba(59, 130, 246, 0.2)", color: "#1e3a5f", textAlign: "center",
  },
  ...
  backHome: {
    ...
    textDecoration: "none", borderRadius: "50px", fontWeight: "600", fontSize: "0.95rem",
  },
};
